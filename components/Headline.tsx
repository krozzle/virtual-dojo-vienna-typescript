const Headline = () => (
  <div className="flex flex-col min-h-screen items-center justify-center">
    ...
    <div className="flex text-center justify-center text-center text-white text-6xl font-extrabold w-2/3 p-2 uppercase">
      {' '}
      Virtual Dojo <div className="text-center text-red-700"> | </div>{' '}
      <div className="text-center font-light">Vienna</div>
    </div>
    <div className="w-full justify-center text-white bg-opacity-0 p-2 text-center text-4xl pt-8 uppercase">
      <div className="">
